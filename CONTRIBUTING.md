# Contributing to dig-collateral-coin
...
- Include crate version (`Cargo.toml` `version`, or `cargo tree -p dig-collateral-coin`) and
...
- `rust-checks`
- `Build and test on ubuntu-latest - Rust stable`
- `Build and test on macos-latest - Rust stable`
- `Build and test on windows-latest - Rust stable`
